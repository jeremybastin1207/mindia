...
/// Do not use as a "no tenant" sentinel: use `Option<Uuid>` or a separate sentinel if you need to represent absence of tenant.
...
/// Do not use as a "no user" sentinel; use `Option<Uuid>` or a separate sentinel for absence.
